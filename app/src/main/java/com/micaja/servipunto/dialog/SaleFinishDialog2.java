...
public class SaleFinishDialog2 extends Dialog implements
	...
	public SaleFinishDialog2(Context context, double totalAmount,
	...
	private boolean SynkcentralServer() {
		return true;
	}
	...
	private boolean validateFields(StringBuffer stringBuffer, String payAmount,
		...
		if (appContext.getClientDTO() == null
			...
			/*
			 * if(invoiceNum.length() == 0) { isValid = false;
			 * stringBuffer.append
			 * ("\n"+context.getResources().getString(R.string.enter_invoice));
			 * } else if(".".equals(invoiceNum)) { isValid = false;
			 * stringBuffer.
	...
	public void setOnDialogSaveListener(OnDialogSaveClickListener2 listener) {
		...
		// public void setOnDialogCancelListener(OnDialogSaveClickListener1
		// listener) {
