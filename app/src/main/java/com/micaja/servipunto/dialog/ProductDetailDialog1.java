...
public class ProductDetailDialog1 extends Dialog implements
	...
	public ProductDetailDialog1(Context context) {
	...
	public void setOnDialogSaveListener(OnDialogSaveClickListener1 listener) {
