...
public class DevolucionDialog2 extends Dialog implements android.view.View.OnClickListener {
	...
	private String serverresponds;
	private AcceptEfectivoDTO aedto = new AcceptEfectivoDTO();
	private Handler uiHandler;
	private String value, patner, IdCentroAcopio, fecha, hora;
	private String server_res;

	public DevolucionDialog2(Context context, AcceptEfectivoDTO aedto2, Handler uiHandler, String value, String patner,
			String server_res) {
		super(context);
	...
	private void initUI() {
		setContentView(R.layout.devolucion_dialog2);
		img_close = (ImageView) findViewById(R.id.img_close);
		txtauthNumber = (TextView) findViewById(R.id.txtauthNumber);
		...
		try {
			...
			txtauthNumber.setText(aedto.getIdCentroAcopio());
			IdCentroAcopio = aedto.getIdCentroAcopio();
	...
	private void printOperation() {
		...
		ServiApplication.print_flage_eps = context.getResources().getString(R.string.twob_line11) + "\n"
				...
				+ context.getResources().getString(R.string.devolucion_message) + "\n" + aedto.getIdCentroAcopio()
				+ "\n\n" + context.getResources().getString(R.string.twob_line12) + "       " + patner + "\n\n\n";
