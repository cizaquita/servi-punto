...
public class ControlDispersionDialog3 extends Dialog implements OnClickListener {
	Boolean Isvalid;
	...
	private ControlDispersionDTO dto;

	public ControlDispersionDialog3(Context context, ControlDispersionDTO dto) {
		super(context);
	...
	private void loadUi() {
		txtv_dispersinmssg.setText(context.getResources().getString(
				...
				+dto.getValor() +" : " + context.getResources().getString(R.string.sureExit));
	}
