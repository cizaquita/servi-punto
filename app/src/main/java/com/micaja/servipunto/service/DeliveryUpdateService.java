...
public class DeliveryUpdateService extends Service {
	...
	public void onCreate() {
		super.onCreate();
		if (NetworkConnectivity.netWorkAvailability(DeliveryUpdateService.this)) {
	...
	class CickServer extends AsyncTask<String, Void, Void> {
		...
		protected Void doInBackground(String... params) {
			...
			new ServiceHandler(DeliveryUpdateService.this).makeServiceCall(
					ServiApplication.URL + "/sync", ServiceHandler.POST,
					new RequestFiels(DeliveryUpdateService.this)
