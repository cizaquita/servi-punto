...
public class ReportDetailsActivity1 extends BaseActivity implements
	...
	private void setScreenName() {
		...
		case 12:
			...
			product_quntity.setText(getString(R.string.type));
	...
	private void GetConsultarTransacciones() {
		if (NetworkConnectivity
				.netWorkAvailability(ReportDetailsActivity1.this)) {
			new GetConsultarTransacciones(userdto.getUserName(),
					userdto.getPassword()).execute();
		} else {
			CommonMethods.showCustomToast(ReportDetailsActivity1.this,
	...
	private void showFilters() {
		...
		final Dialog dialog = new Dialog(ReportDetailsActivity1.this);
		...
		ArrayAdapter adapter = new ArrayAdapter(ReportDetailsActivity1.this,
	...
	public class GetReportDetails extends AsyncTask<String, Void, Void> {
		...
		protected Void doInBackground(String... params) {
			ServiApplication.responds_feed = new ServiceHandler(
					ReportDetailsActivity1.this).makeServiceCall(
					ServiApplication.URL + "/reports/"
							+ report_options[selectedReport],
			...
			if (ServiApplication.connectionTimeOutState) {
				if (new ParsingHandler().getInventoryAmount(
					...
					lvReportDetails.setAdapter(new ReportDetailsAdapter(
							ReportDetailsActivity1.this, new ParsingHandler()
									.getInventoryAmount(
	...
	private class GetConsultarTransacciones extends
		...
		private String SoapOperatorID, encrypt_key, json;
		...
		protected Boolean doInBackground(Void... params) {
			try {
				...
				if (selectedReport == 11) {
					...
					request.addProperty(MakeHeader.makepropertyInfo1(MakeHeader
							.makeHeader(ReportDetailsActivity1.this,
									encrypt_key,
		...
		protected void onPostExecute(final Boolean success) {
			...
			if (exception) {
				...
				if (selectedReport == 11) {
					lvReportDetails.setAdapter(new ReportDetailsAdapter(
							ReportDetailsActivity1.this, CTDto, 11));
				} else if (selectedReport == 12) {
					lvReportDetails.setAdapter(new ReportDetailsAdapter(
							ReportDetailsActivity1.this, CTDto, 12));
				} else if (selectedReport == 13) {
					lvReportDetails.setAdapter(new ReportDetailsAdapter(
							ReportDetailsActivity1.this, CTDto, 13));
				} else if (selectedReport == 14) {
					lvReportDetails.setAdapter(new ReportDetailsAdapter(
							ReportDetailsActivity1.this, CTDto, 14));
				} else if (selectedReport == 15) {
					lvReportDetails.setAdapter(new ReportDetailsAdapter(
							ReportDetailsActivity1.this, CTDto, 15));
				} else if (selectedReport == 16) {
					lvReportDetails.setAdapter(new ReportDetailsAdapter(
							ReportDetailsActivity1.this, CTDto, 16));
				} else if (selectedReport == 17) {
					lvReportDetails.setAdapter(new ReportDetailsAdapter(
							ReportDetailsActivity1.this, CTDto, 17));
				} else if (selectedReport == 18) {
					lvReportDetails.setAdapter(new ReportDetailsAdapter(
							ReportDetailsActivity1.this, CTDto, 18));
				} else if (selectedReport == 19) {
					lvReportDetails.setAdapter(new ReportDetailsAdapter(
							ReportDetailsActivity1.this, CTDto, 19));
				} else if (selectedReport == 20) {
					lvReportDetails.setAdapter(new ReportDetailsAdapter(
							ReportDetailsActivity1.this, CTDto, 20));
				}
			}
		}
	}
	...
	public void onBackPressed() {
		...
		CommonMethods.openNewActivity(ReportDetailsActivity1.this, MenuActivity.class);
	}
}
