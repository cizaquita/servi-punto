...
public class SyncDataFromServerChangedClass {
	...
	public SyncDataFromServerChangedClass(Context context, int value) {
	...
	// public class DishDataFromCentralServer extends AsyncTask<Void, Void,
	// Void> {
	// String responds;
	//
	// @Override
	...
	// .getRecordsByDish_id(DBHandler.getDBObj(Constants.READABLE),
	// dDTO.getDishId());
	// List<DTO> dishList = new ArrayList<DTO>();
	// if (local_product_listDTO.getDishId() != null) {
	// DishesDAO.getInstance().update(DBHandler.getDBObj(Constants.WRITABLE),
	// dDTO);
	// } else {
	// dishList.add(dDTO);
	...
	//
	// try {
	// ServiApplication.setDownloded_count(ServiApplication.getDownloded_count()+json.getJSONArray("data").length());
	// } catch (Exception e) {
	// ServiApplication.setDownloded_count(0);
	// }
	//
	...
	// + " "
	// + ServiApplication.getDownloded_count() + " "
	// + mContext.getString(R.string.auto_sync_messsage2) + " " +
	// ServiApplication.getTotal_count()
	// + " " + mContext.getString(R.string.auto_sync_messsage3) + " "
	// + ServiApplication.getDownloded_table_name(), mContext);
	// new DishDataFromCentralServer().execute();
	// } else {
	// CommonMethods.showCustomToast(mContext,
	// mContext.getResources().getString(R.string.no_wifi_adhoc)+mContext.getResources().getString(R.string.or)+mContext.getResources().getString(R.string.db_errormessage));
	// CommonMethods.dismissProgressDialog();
	// }
	// } catch (Exception e) {
	//
	...
	// public class DishProductsFromCentralServer extends AsyncTask<Void, Void,
	// Void> {
	// String responds;
	//
	// @Override
	...
	// super.onPostExecute(result);
	// if (ServiApplication.connectionTimeOutState) {
	// ServiApplication.dish_products = new
	// ParsingHandler().getdish_products(responds);
	// if (gdto.getName().equals("babu")) {
	// DishesDAO.getInstance().insert(DBHandler.getDBObj(Constants.WRITABLE),
	...
	// List<DTO> dishList = new ArrayList<DTO>();
	// if (local_product_listDTO.getDishId() != null) {
	// DishProductsDAO.getInstance().update(DBHandler.getDBObj(Constants.WRITABLE),
	// dpDTO);
	// } else {
	// dishList.add(dpDTO);
	// DishProductsDAO.getInstance().insert(DBHandler.getDBObj(Constants.WRITABLE),
	// dishList);
	// }
	// }
	// }
	...
	// public class DamageTypeDataFromCentralServer extends AsyncTask<Void,
	// Void, Void> {
	// String responds;
	//
	// @Override
	...
	// if (ServiApplication.connectionTimeOutState) {
	//
	// ServiApplication.damage_type = new
	// ParsingHandler().getdamage_type(responds);
	// if (gdto.getName().equals("babu")) {
	...
	// .getRecordsByDamage_id(DBHandler.getDBObj(Constants.READABLE),
	// dyDTO.getDamageTypeId());
	// List<DTO> dishList = new ArrayList<DTO>();
	// if (local_product_listDTO.getDamageTypeId() != null) {
	// DamageTypeDAO.getInstance().update(DBHandler.getDBObj(Constants.WRITABLE),
	// dyDTO);
	// } else {
	// dishList.add(dyDTO);
	// DamageTypeDAO.getInstance().insert(DBHandler.getDBObj(Constants.WRITABLE),
	...
	public class SupplierDataFromCentralServer extends AsyncTask<Void, Void, Void> {
		...
		private void callto9thmethod() {
			...
			try {
				...
				if (NetworkConnectivity.netWorkAvailability(mContext)) {
					CommonMethods.showProgressDialog(mContext.getString(R.string.auto_sync_messsage1) + " "
							+ ServiApplication.getSupplier_downloded_count() + " "
							+ mContext.getString(R.string.auto_sync_messsage2) + " " + ServiApplication.getSupplier_total_count()
							+ " " + mContext.getString(R.string.auto_sync_messsage3) + " "
							+ ServiApplication.getDownloded_table_name(), mContext);
	...
	public class ProductDataFromCentralServer extends AsyncTask<Void, Void, Void> {
		...
		private void callto8thmethod() {
			...
			try {
				...
				if (NetworkConnectivity.netWorkAvailability(mContext)) {
					CommonMethods.showProgressDialog(mContext.getString(R.string.auto_sync_messsage1) + " "
							+ ServiApplication.getProduct_downloded_count() + " "
							+ mContext.getString(R.string.auto_sync_messsage2) + " " + ServiApplication.getProduct_total_count()
							+ " " + mContext.getString(R.string.auto_sync_messsage3) + " "
							+ ServiApplication.getDownloded_table_name(), mContext);
	...
	// public class LineDataFromCentralServer extends AsyncTask<Void, Void,
	// Void> {
	// String responds;
	//
	// @Override
	...
	// .getRecordsByline_id(DBHandler.getDBObj(Constants.READABLE),
	// lDTO.getLineId());
	// List<DTO> dishList = new ArrayList<DTO>();
	// if (local_product_listDTO.getLineId() != null) {
	// LineDAO.getInstance().update(DBHandler.getDBObj(Constants.WRITABLE),
	// lDTO);
	// } else {
	// dishList.add(lDTO);
	// LineDAO.getInstance().insert(DBHandler.getDBObj(Constants.WRITABLE),
	...
	// public class MenusInventoryDataFromCentralServer extends AsyncTask<Void,
	// Void, Void> {
	// String responds;
	//
	// @Override
	...
	// if (ServiApplication.connectionTimeOutState) {
	//
	// ServiApplication.menu_inventory = new
	// ParsingHandler().getmenuInventory(responds);
	// if (gdto.getName().equals("babu")) {
	// MenuInventoryDAO.getInstance().insert(DBHandler.getDBObj(Constants.WRITABLE),
	// ServiApplication.menu_inventory);
	// } else {
	...
	// MenuInventoryDAO.getInstance().update(DBHandler.getDBObj(Constants.WRITABLE),
	// dyDTO);
	// } else {
	// dishList.add(dyDTO);
	// MenuInventoryDAO.getInstance().insert(DBHandler.getDBObj(Constants.WRITABLE),
	...
	// public class MenusTypeDataFromCentralServer extends AsyncTask<Void, Void,
	// Void> {
	// String responds;
	//
	// @Override
	...
	// super.onPostExecute(result);
	// if (ServiApplication.connectionTimeOutState) {
	// ServiApplication.menu_type = new
	// ParsingHandler().getmenusTypes(responds);
	// if (gdto.getName().equals("babu")) {
	...
	// .getRecordsMenu_type_id(DBHandler.getDBObj(Constants.READABLE),
	// dyDTO.getMenuTypeId());
	// List<DTO> dishList = new ArrayList<DTO>();
	// if (local_product_listDTO.getMenuTypeId() != null) {
	// MenuTypesDAO.getInstance().update(DBHandler.getDBObj(Constants.WRITABLE),
	// dyDTO);
	// } else {
	// dishList.add(dyDTO);
	// MenuTypesDAO.getInstance().insert(DBHandler.getDBObj(Constants.WRITABLE),
	...
	// public class MenusDataFromCentralServer extends AsyncTask<Void, Void,
	// Void> {
	//
	// String responds;
	//
	...
	// if (gdto.getName().equals("babu")) {
	// MenuDAO.getInstance().insert(DBHandler.getDBObj(Constants.WRITABLE),
	// ServiApplication.menus);
	// } else {
	// for (DTO dto : ServiApplication.menus) {
	// MenuDTO mdto = (MenuDTO) dto;
	// MenuDTO local_client_listDTO = MenuDAO.getInstance()
	// .getRecordsMenu_id(DBHandler.getDBObj(Constants.READABLE),
	// mdto.getMenuId());
	// List<DTO> clientListList = new ArrayList<DTO>();
	// if (local_client_listDTO.getMenuId() != null) {
	// MenuDAO.getInstance().update(DBHandler.getDBObj(Constants.WRITABLE),
	// mdto);
	//
	// } else {
	...
	// public class MenusDishesDataFromCentralServer extends AsyncTask<Void,
	// Void, Void> {
	//
	// String responds;
	//
	...
	// if (ServiApplication.connectionTimeOutState) {
	//
	// ServiApplication.menu_dishes = new
	// ParsingHandler().getmenusDishs(responds);
	// if (gdto.getName().equals("babu")) {
	...
	// MenuDishesDTO local_client_listDTO = (MenuDishesDTO)
	// MenuDishesDAO.getInstance()
	...
	// MenuDishesDAO.getInstance().update(DBHandler.getDBObj(Constants.WRITABLE),
	// mdishdto);
	// } else {
	...
	public class ClientDataFromCentralServer extends AsyncTask<Void, Void, Void> {
		...
		private void callto5thmethod() {
			...
			try {
				...
				if (NetworkConnectivity.netWorkAvailability(mContext)) {
					CommonMethods.showProgressDialog(mContext.getString(R.string.auto_sync_messsage1) + " "
							+ ServiApplication.getClient_downloded_count() + " "
							+ mContext.getString(R.string.auto_sync_messsage2) + " " + ServiApplication.getClient_total_count()
							+ " " + mContext.getString(R.string.auto_sync_messsage3) + " "
							+ ServiApplication.getDownloded_table_name(), mContext);
					new ClientDataFromCentralServer().execute();
				} else {
...
//					synkMethod();
	...
	// public class GroupDataFromCentralServer extends AsyncTask<Void, Void,
	// Void> {
	// String responds;
	//
	// @Override
	...
	//
	// gdto.setName("babu");
	// GroupDAO.getInstance().DBLMupdate(DBHandler.getDBObj(Constants.WRITABLE),
	// gdto);
	// } else {
	// gdto.setName("varun");
	// GroupDAO.getInstance().DBLMupdate(DBHandler.getDBObj(Constants.WRITABLE),
	...
	public void synkMethod() {
		...
		if (new AsynkTaskClass().callcentralserver("/sync", "" + ServiceHandler.POST,
			...
			if (new JSONStatus().status(ServiApplication.responds_feed) == 0) {
				...
				CommonMethods.startIntent(((Activity) mContext), MenuActivity.class);
				((Activity) mContext).finish();
				CommonMethods.showCustomToast(((Activity) mContext),
						mContext.getResources().getString(R.string.sync_error_msg));
			}
		} else {
			CommonMethods.dismissProgressDialog();
			CommonMethods.startIntent(((Activity) mContext), MenuActivity.class);
